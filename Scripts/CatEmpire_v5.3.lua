...
Options.AutoFarm:OnChanged(function(v)
    toggleLoop("AutoFarm", v, 0.35, function()
        ...
        -- Não passa o model Instance (não serializa via remote)
        -- Passa só as strings: world e ID
...
Options.DailyRewards:OnChanged(function(v)
    -- Intervalo curto — só tenta o dia atual, repete até conseguir
    -- O servidor rejeita dias já coletados com "already been claimed", sem problema
    toggleLoop("DailyRewards", v, 1.5, function()
        for day = 1, 7 do
