-- ============================================================
--  CAT EMPIRE | v5.14 | CODED FOR DANONIN
--  UI: Fluent Library
...
-- FIX: declarações ANTES de qualquer InputBegan/InputEnded que as use
...
-- Busca o frame do Fluent depois que a window existir
...
UIS2.InputEnded:Connect(function(i)
    ...
    or i.UserInputType == Enum.UserInputType.Touch then
        fbDragging = false
        if not fbMoved then
            -- Toggle visibilidade: usa MinimizeKey do Fluent (simula RightControl)
            -- que é o método correto para o Fluent esconder/mostrar a janela
