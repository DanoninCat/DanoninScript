-- ============================================================
--  DANONIN HUB | Anime Capture v3.5
...
Tabs.Info:AddParagraph({ Title="Script",  Content="Anime Capture v3.5" })
...
Fluent:Notify({
    Title    = "Danonin Hub",
    Content  = "Anime Capture v3.5 carregado!",
    Duration = 5,
})

warn("[AC] v3.5 carregado | Theme: "..Config.Theme.." | "..#RF:GetChildren().." remotes | fluentSG: "..(fluentSG and fluentSG.Name or "nil"))
