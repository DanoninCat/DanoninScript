-- ============================================================
--  DANONIN HUB | Anime Capture v3.1
...
Tabs.Info:AddParagraph({ Title="Script",  Content="Anime Capture v3.1" })
...
Fluent:Notify({
    Title    = "Danonin Hub",
    Content  = "Anime Capture v3.1 carregado!",
    Duration = 5,
})

warn("[AC] v3.1 carregado | Theme: "..Config.Theme.." | "..#RF:GetChildren().." remotes | fluentSG: "..(fluentSG and fluentSG.Name or "nil"))
