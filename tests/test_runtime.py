...
class RuntimeTests(unittest.TestCase):
    ...
    def test_settings_and_matchmaking_regression_guards(self):
        ...
        self.assertNotIn('dawid-scripts/Fluent/master/Addons/InterfaceManager.lua',entry)
        self.assertNotIn('dawid-scripts/Fluent/master/Addons/SaveManager.lua',entry)
        self.assertIn('local SaveManager = Fluent.SaveManager',entry)
        self.assertIn('local InterfaceManager = Fluent.InterfaceManager',entry)
        self.assertIn('InterfaceManager:BuildInterfaceSection(Settings)',entry)
        self.assertNotIn('function UI.AttachInterfaceSettings',ui)
